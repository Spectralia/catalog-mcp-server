...
Started from the Python weather server in [modelcontextprotocol/quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources). The quickstart was scaffolding: its conventions and stdio entry point carried over, its weather domain did not. The other language examples from that repository have been removed.
